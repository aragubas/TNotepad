...
namespace Installer
{
    static class Program
    {
        ...
        {
            // Set Temp Dir
            TempDirToWorkWith = Path.GetTempPath() + "\\TaiyouTabNotepadInstaller\\";
            Console.WriteLine("TabNotepad installer v" + GetVersionWithBuild());
            ...
            // Create Main Window
            TaiyouUI.Utils.CreateWindow(new InstallerPage1(), "TNotepad Installer");
